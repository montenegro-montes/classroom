...
public class BusquedaVoraz extends Busqueda{
	...
	public BusquedaVoraz(Problema p,Heuristic heuristic, FuncionTranscion f) {
		super(p);
		 _heuristic =  heuristic;
		 _fa			=  f;
		 name = "Greedy "+f.getName();
	}
	...
	public static void main(String[] args) {
		...
		BusquedaVoraz b = new BusquedaVoraz(nuevoProblema,new HeuristicManhattan(),new FuncionTranscionOcho());
