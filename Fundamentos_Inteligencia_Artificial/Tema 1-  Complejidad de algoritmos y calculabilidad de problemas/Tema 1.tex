...
\begin{block}{Definición 15:  Función WHILE-computable, F(WHILE)}
\end{block}
...
\begin{block}{Definición 16:  T-WHILE}
\end{block}
...
\begin{block}{Definición 17:  P es un predicado WHILE-decidible, PRED(T-WHILE)}
\end{block}
\begin{center}
...
\begin{block}{Definición 18:  P es un predicado WHILE-enumerable, PRED(WHILE)}
\end{block}
...
\[codi(s) = \left\{ \begin{array}{ll} 
            5(i-1) & si\; s = X_i:=0 \\
            5 \sigma^2_1(i-1, j-1)+1 & si\; s = X_i:= X_j\\
            5 \sigma^2_1(i-1, j-1)+2 & si\; s = X_i:= X_j +1\\
            5 \sigma^2_1(i-1, j-1)+3 & si\; s = X_i:= X_j -1\\ 
            5 \sigma^2_1(i-1, Codi(s_1))+4 & si\;  s = while\; X_i \neq 0 \; do\; s_1\; od
            \end{array} \right. \]
