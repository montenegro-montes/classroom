...
\subtitle{Introducción Sistemas Inteligentes}
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{¿Qué es IA?}
\end{chapter}
...
\begin{figure}
\includegraphics[scale=0.4]{./img/queEsIA}
\end{figure}
...
\item ¿Cómo funciona Google driverless car (Waymo) - Tesla?
\item ¿Cómo funciona Asistentes: Siri, Hound, AlexaWiki?
\item ¿Qué son los modelos de lenguaje de gran tamaño?
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Paradigmas y tendencias en la investigación de la IA}
\end{chapter}
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Agentes Inteligentes}
\end{chapter}
...
\begin{center}
	\includegraphics[scale=0.3]{img/aspiradora} \\
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Naturaleza del Entorno}
\end{chapter}
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Estructura de los Agentes}
\end{chapter}
...
\begin{frame}\frametitle{Agentes basado en utilidad} \footnotesize  
 ...
 \begin{center}
	\includegraphics[scale=0.3]{img/AgentesBasadosUtilidad} 
\end{center}
...
\begin{frame}\frametitle{Agentes que aprenden} \footnotesize  
 ...
 \begin{center}
	\includegraphics[scale=0.3]{img/AgentesAprenden} 
\end{center}
...
%\end{frame} 
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Agentes resolventes-problemas}
\end{chapter}
