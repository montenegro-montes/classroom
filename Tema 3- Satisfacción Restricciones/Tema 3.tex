...
\subtitle{Satisfacción Restricciones}
...
\begin{itemize}
\item En los temas 4,5 y 6 vamos a explorar problemas que pueden resolverse buscando en un espacio de estados

\item Cada estado será atómico, es decir, era una caja negra sin estructura interna.
...
\begin{itemize}
\item En los temas 4,5 y 6 evaluaremos los nodos por una función asociada a cada estado ya que son estados atómicos, F(n).
...
\item Un conjunto de \textbf{dominios}, uno para cada variable: $D=\{D_1,\ldots , D_n\}$
...
\begin{figure}
\includegraphics[scale=0.45]{./img/MapaEspaña}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.2]{./img/Cripto}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.3]{./img/Nreinas}
\end{figure}
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Restricciones y Consistencia}
\end{chapter}
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Propagación de Restricciones}
\end{chapter}
...
\begin{itemize}
\item Una variable $X_i$ es \textbf{arco-consistente} si, para cada valor del dominio de $X_i$ y cada \textbf{restricción binaria} $(X_i,X_j)$, podemos encontrar al menos un valor en el dominio de $X_j$ que satisface la restricción

\item Una red es \textbf{arco-consistente} si toda variable es arco-consistente con las demás variables
...
\begin{center}
    \textbf{Algoritmo de revisión de dominios}
\end{center}
...
\begin{figure}
\includegraphics[scale=0.4]{./img/EjAC3_5}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.40]{./img/EjAC3_8}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.40]{./img/Ej_2AC3}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.40]{./img/Ej_3AC3}
\end{figure}
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Algoritmos}
\end{chapter}
\section{Algoritmos}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item  La búsqueda por vuelta atrás es una búsqueda primero en profundidad que en cada momento elige un valor para una sola variable, y vuelve atrás cuando una variable no tiene ningún valor legal que quede por probar.
...
\begin{center}
\textbf{(minimum remaining values heuristic, MRV)}
\end{center}
...
\item También es posible emplear el \textbf{heurístico del grado (degree heuristic, DEG)}, que elige la variable que interviene en el mayor número de restricciones con otras variables no asignadas.
...
En algunos casos el \textbf{heurístico del valor menos restrictivo (least constraining value, LCV)} puede resultar útil

\begin{itemize}
\item Elige un valor que restrinja menos las opciones de los demás variables vecinas en el grafo de restricciones.
...
\begin{figure}
\includegraphics[scale=0.45]{./img/OrdenValores}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}  \frametitle{3. Intercalando búsqueda e inferencias} \small
...
\item Una de las estrategias más sencillas es la comprobación hacia delante (\textbf{forward checking}):
...
\begin{figure}
\includegraphics[scale=0.35]{./img/FC}
\end{figure}
...
\begin{center}
\textbf{Forward Checking y MRV (heurístico del mínimo número de valores restantes)}    
\end{center}

\begin{figure}
\includegraphics[scale=0.35]{./img/FC_MRV}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.30]{./img/Back_NReinas}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.25]{./img/BC_FC_Nreinas}
\end{figure}
...
\begin{chapter}[images/etsiinformatica4.png]{uicblue}{Resumen}
\end{chapter}
